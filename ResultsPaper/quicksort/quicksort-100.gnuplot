...
plot  'quicksort-100.dat' using 1:3 title "Accelerate, Regular" ls 1 lw 3 with linespoints, \
      'quicksort-100.dat' using 1:4 title "Accelerate"          ls 2 lw 3 with linespoints, \
      'quicksort-100.dat' using 1:2 title "Futhark"             ls 3 lw 3 with linespoints
